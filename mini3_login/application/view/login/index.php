...
<body>
    ...
    <div class="wrapper">
        <div id="formContent">
            ...
            <!-- Icon -->
            <div>
                <img src="<?php echo URL; ?>login_libs/icon.svg" id="icon" alt="User Icon" />
            </div>
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
                <a class="underlineHover" href="<?php echo URL; ?>login/register">No tienes cuenta, registrate.</a>
                <br>
                <a class="underlineHover" href="<?php echo URL; ?>login/recover">¿Olvidaste la contraseña?</a>
            </div>
